...
import dev.at.productservice.models.Category;
import dev.at.productservice.models.Product;
...
//    List<Product> findAllByCategoryIn(List<UUID> uuids);
    ...
    List<Product> findAllByTitle(String akhilesh);

//    @Query("select Product from Product where Product.price.currency = :currency and Product.title = :akhilesh")
//    List<Product> doSomething(String akhilesh, String currency);
}
